...
if(isset($_POST["submit"])) {
  ...
  while($atrow = mysqli_fetch_array($atresult)) { 
      ...
      $inp = "INSERT INTO `islamiat_rel`(`date`, `class_id`, `user id`, `total`, `obt`, `status`) VALUES ('$date','$cid','$ud','$total','$obt','$status')";
            ...
            <div class="page-header">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Islamiat/Religion Test</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <form action="#" method="post">
                      <h4 class="card-title">Update Islamiat/Religion Test Marks</h4>
