...
if(isset($_POST["submit"])) {
  ...
  while($atrow = mysqli_fetch_array($atresult)) { 
      ...
      $inp = "INSERT INTO `math`(`date`, `class_id`, `user_id`, `total`, `obt`, `status`) VALUES ('$date','$cid','$ud','$total','$obt','$status')";
...
<html lang="en">
  <head>
    ...
    <!-- End layout styles -->
    <link rel="shortcut icon" href="../../bg_img_small.png" />  </head>
  <body>
            ...
            <div class="page-header">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Math Test</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <form action="#" method="post">
                      <h4 class="card-title">Update Math Test Marks</h4>
