...
if(isset($_POST["submit"])) {
  ...
  while($atrow = mysqli_fetch_array($atresult)) { 
      ...
      $inp = "INSERT INTO `sindhi`(`date`, `class_id`, `user_id`, `total`, `obt`, `status`) VALUES ('$date','$cid','$ud','$total','$obt','$status')";
            ...
            <div class="page-header">
              <nav aria-label="breadcrumb">
                <ol class="breadcrumb">
                  ...
                  <li class="breadcrumb-item active" aria-current="page">Sindhi Test</li>
                </ol>
              </nav>
            </div>
            <div class="row">
                ...
                <div class="card">
                  <div class="card-body">
                    <form action="#" method="post">
                      <h4 class="card-title">Update Sindhi Test Marks</h4>
