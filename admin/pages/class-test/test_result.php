                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>      
                                    <?php
                                        $cls = "SELECT c.id FROM `class` c WHERE `Class_name` = 'VII' ORDER BY `id` DESC LIMIT 1";
                                        $clsres = mysqli_query($conn, $cls);
                                        $cls_row = mysqli_fetch_array($clsres);
                                        $name = $cls_row["id"];
                                        $users = "SELECT u.id,u.F_name FROM `users` u WHERE `Class_id` = '$name' ORDER BY `id` DESC";                                        
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>      
                                    <?php
                                        $cls = "SELECT c.id FROM `class` c WHERE `Class_name` = 'VIII' ORDER BY `id` DESC LIMIT 1";
                                        $clsres = mysqli_query($conn, $cls);
                                        $cls_row = mysqli_fetch_array($clsres);
                                        $name = $cls_row["id"];
                                        $users = "SELECT u.id,u.F_name FROM `users` u WHERE `Class_id` = '$name' ORDER BY `id` DESC";                                        
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>      
                                    <?php
                                        $cls = "SELECT c.id FROM `class` c WHERE `Class_name` = 'IX' ORDER BY `id` DESC LIMIT 1";
                                        $clsres = mysqli_query($conn, $cls);
                                        $cls_row = mysqli_fetch_array($clsres);
                                        $name = $cls_row["id"];
                                        $users = "SELECT u.id,u.F_name FROM `users` u WHERE `Class_id` = '$name' ORDER BY `id` DESC";                                        
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <table class="table table-striped">
                                ...
                                <tbody>      
                                    <?php
                                        $cls = "SELECT c.id FROM `class` c WHERE `Class_name` = 'X' ORDER BY `id` DESC LIMIT 1";
                                        $clsres = mysqli_query($conn, $cls);
                                        $cls_row = mysqli_fetch_array($clsres);
                                        $name = $cls_row["id"];
                                        $users = "SELECT u.id,u.F_name FROM `users` u WHERE `Class_id` = '$name' ORDER BY `id` DESC";                                        
