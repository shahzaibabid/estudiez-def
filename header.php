                        ...
                        <div class="top-nav-mini-cart-icon-contents">
                          ...
                          <div class="dropdown-content">
                            <ul class="cart_list product_list_widget">
                              ...
                              <center>
                               <img class="attachment-thumbnail" src="images/shop/product.jpg" style="height: 80px; border-radius: 100%;" alt=""/>
                               <h4 class="total"> <strong>name</strong> <span class="woocommerce-Price-amount amount"><span class="currencySymbol"> </h3>
